...
const FilterSidebar = () => {
  ...
  const materials=[
    "Cotton","Wool","Denim","Pollyester","Silk","Linen","Viscose","Fieece"
  ];
  const brands=[
    "Urban Threads",
    "Street Style",
  ...
  useEffect(()=>{
    ...
    //{category:"Top Wear",""},{gender:""}=>params.category like this it converts 
    setFilters({
    ...
    <div className='p-4'>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          className={`w-8 h-8 rounded-full cursor-pointer border border-gray-300 transition hover:scale-105
